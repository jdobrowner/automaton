...
class SidebarContainer extends Component {
  constructor () {
    ...
    this.state = {
      ...
      speed: 1000,
      sidebarSize: "sidebar sidebar-shown",
      showhideClass: "show-rotate"
    };
  ...
  toggleSidebar() {
    ...
    const sidebarSize = showSidebar ? "sidebar sidebar-shown" : "sidebar sidebar-hidden";
...
getSelectedRuleset(title) {
  if ((this.props.ruleset === title) || (this.props.ruleset === title + ' random')) return true;
  else return false;
}
...
render() {
    ...
    return (
      <div className="sidebar-container">
        ...
        <div className={ this.state.showhideClass } id="show-hide" style={ showhideStyling } onClick={ this.toggleSidebar }>
          <svg height="20" width="20">
            <path d="M18 2 L2 10 L18 18 Z" fill={arrowFill} />
          </svg>
        </div>

        <div className={ this.state.sidebarSize } style={sidebarStyling}>
          <h1 className="title"> cellular <br /> automaton </h1>
          <div className="what-is-this" onClick={ this.toggleExplanation } >
            <h2>what is this?</h2>
          </div>
